        ...
        <div id="lower-text">
          ...
          <div class="image-text" id="personal-text">
            ...
            <ul id="list">
              ...
              <li><a href="">Game Deveopment</a></li>
              <li><a href="">Creatives</a></li>
            </ul>
          </div>
        </div>
        <div id="email-text">matt.r.howlett@gmail.com — <a href="">Resume</a></div>
      </div>
    </body>
  </div>
</template>
